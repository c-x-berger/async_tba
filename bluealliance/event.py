...
class SimpleEvent(Model):
    def __init__(self, conn_state: ConnectionState, key: str = None, name: str = None, event_code: str = None,
                 city: str = None, state_prov: str = None, country: str = None,
                 start_date: str = None, end_date: str = None, year: int = None):
...
class Event(SimpleEvent):
    def __init__(self, conn_state: ConnectionState, key: str = None, name: str = None, event_code: str = None,
        ...
        super().__init__(conn_state, key=key, name=name, event_code=event_code, city=city,
                         state_prov=state_prov, country=country, start_date=start_date, end_date=end_date, year=year)
